# XYZ_Clothing
## Description
A template for an online shopping website called xyz-clothing with different products on display for sale.
...
Go to the directory where 'xyz-clothing' is located on your local machine in command prompt or powershell and type 'npm i react-scripts'.
